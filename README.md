...
| 左侧 - 技术架构 | 中间 - 核心功能 | 右侧 - 部署与演示 |
|---------------|----------------|------------------|
| 双场景预测系统 | 零售销售额预测系统 | 云端部署 Streamlit Cloud |
| Python + Pandas | 随机森林 + 线性回归 | 线下演示地址：[链接] |
| Scikit-learn 调参 | GridSearchCV 优化 | 在线演示地址：[链接] |
| MySQL / CSV / Excel | 特征重要性分析 | 对比分析双场景结果 |
| Joblib 模型持久化 | 模型评估 R²/MAE/RMSE | 零成本部署示例 |
## 支持功能
